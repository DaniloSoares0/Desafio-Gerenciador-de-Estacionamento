    ...
    public static class MotoristaBuilder {
        ...
        public MotoristaBuilder withIdade(int idade) {
        	...
        	if(idade <= 0 ) {
        		...
        		throw new IllegalArgumentException("Idade ou Pontos negativos não são permitidos");
        	}else {
        ...
        public Motorista build() {
        	...
        	if(nome == null || habilitacao == null) {
        		...
        		throw new NullPointerException("Campo idade ou habiltação vazios  não são permitidos");

        	} if(pontos < 0){

        		throw new EstacionamentoException("Motoristas sem pontuação não são permitidos");
